...
основную страницу, где и располагаются пароли. Далее в этом окне: кнопка "Создать пароль" -
создать новую запись; "Удалить" - удалить выделенные записи; "Сохранить" - сохранить
